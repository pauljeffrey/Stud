            ...
            <CardContent className="space-y-6">
              ...
              <div className="border border-purple-500/30 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-3 flex items-center gap-2">
                  <Badge className="bg-blue-600">Google (Gemini)</Badge>
                </h3>
                ...
                <div className="mt-4 bg-blue-900/30 border border-blue-500/30 rounded p-3">
                  <p className="text-sm">
              ...
              <div className="border border-purple-500/30 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-3 flex items-center gap-2">
                  <Badge className="bg-green-600">OpenAI (ChatGPT)</Badge>
                </h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-300">
                  <li>Visit{" "}
                    <a
