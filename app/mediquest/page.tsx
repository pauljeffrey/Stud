...
export default function MediquestPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-black via-[#1E3A8A] to-[#8B5CF6] flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-[#1E3A8A] to-[#8B5CF6] text-white p-4">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 h-[calc(100vh-2rem)]">
          ...
          <Card className="bg-black/40 backdrop-blur-md border-purple-500/30">
            ...
            <CardContent>
              ...
              {gameState.game_world.hospital_name && (
                <Badge className="mt-2 bg-purple-600">{gameState.game_world.hospital_name}</Badge>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              {!gameState.case_state.options && (
                <Textarea
                  ...
                  className="bg-black/50 border-purple-500/30 min-h-[150px]"
                />
              )}
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-purple-500/30 hover:bg-purple-600/30"
                >
              ...
              <AnimatePresence>
                {showReason && gameState.case_state.reason_for_answer && (
                  ...
                  >
                    ...
                    <p className="text-sm">{gameState.case_state.reason_for_answer}</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </CardContent>
            ...
            <Card className="bg-black/40 backdrop-blur-md border-purple-500/30">
              ...
              <CardContent className="space-y-2">
                {gameState.user_performance.map((perf, idx) => (
                  <div key={idx} className="border-b border-purple-500/30 pb-2">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm">Case {idx + 1}</span>
                      <Badge className={perf.score >= 7 ? "bg-green-600" : perf.score >= 5 ? "bg-yellow-600" : "bg-red-600"}>
                        {perf.score}/10
                      </Badge>
                    </div>
                ...
                {gameState.game_master_chat_history.map((msg, idx) => (
                  <div
                    ...
                    className={`p-2 rounded-lg ${
                      msg.role === "user" ? "bg-purple-600/30 ml-4" : "bg-blue-600/30 mr-4"
                    }`}
                  >
