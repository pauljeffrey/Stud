            ...
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold mb-2">Dr. Jeffrey Otoibhi</h3>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-4">
                    <Stethoscope className="h-6 w-6 text-blue-400 mb-2" />
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Badge className="bg-purple-600 mb-2">AI-Powered</Badge>
                  <p className="text-sm text-gray-300">
                    Advanced AI agents create dynamic, personalized learning experiences
                  </p>
                </div>
                <div className="space-y-2">
                  <Badge className="bg-blue-600 mb-2">Gamified</Badge>
                  <p className="text-sm text-gray-300">
                    Earn achievements, progress through levels, track career growth
                  </p>
                </div>
                <div className="space-y-2">
                  <Badge className="bg-pink-600 mb-2">Immersive</Badge>
                  <p className="text-sm text-gray-300">
                    Futuristic design with animations and interactive elements
                  </p>
                </div>
                <div className="space-y-2">
                  <Badge className="bg-green-600 mb-2">Educational</Badge>
                  <p className="text-sm text-gray-300">
